                    ...
                    <tr>
                        ...
                        <?php if ($_SESSION['user']['role'] == 'ADMIN') { ?>
                            <td>
                                ...
                                <a onclick="return confirm('Êtes vous sûr de vouloir supprimer la filière ?')" class="btn btn-danger btn-edit-delete" href="supprimerFiliere.php?idF=<?php echo $filiere['idFiliere'] ?>"> <span class="glyphicon glyphicon-trash"></span></a>
                            <?php } ?>
                            </td>
                        <?php } ?>
                    </tr>
