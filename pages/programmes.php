...
<html>
	...
	<body>
		...
		<div class="container col-lg-offset-2">
			...
			<h1 class="text-center"><strong> Les Programmes</strong> </h1>
						...
						<label> Filière: </label>								
							<select class="form-control" name="id_filiere"
								...
								<?php  foreach($toutes_les_filieres as $filiere) {?>		
									<option 
										value="<?php echo  $filiere['idFiliere'] ?>" 
										<?php if($filiere['idFiliere']===$id_filiere) echo "selected"?> > 
